...
_DeviceType = {_DeviceNames[CONTACT]:     _DevClass["DETECTORS"]  +'\x29',
                ...
                _DeviceNames[FLOOD_551]:         _DevClass["DETECTORS"]  +'\x2D',
...
_DeviceConfigGroups = {
    _DeviceType[_DeviceNames[CONTACT]]:     [0x0001, 0x0016], # ok
    _DeviceType[_DeviceNames[CONTACT_AUX]]:  [0x0001, 0x0016, 0x001B], # ok
    _DeviceType[_DeviceNames[MOTION_SENSOR]]:[0x0001, 0x0002, 0x0003, 0x0004, 0x0014, 0x0016, 0x0018, 0x0050],   # ok
    _DeviceType[_DeviceNames[MOTION_CAMERA]]:[0x0001, 0x0002, 0x0003,\
     0x0004,
     0x000A, 0x000B, 0x000C, 0x000E,\
                0x000F, 0x0010, 0x0014, 0x0016, 0x0018, 0x0019, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x004A, 0x004D,\
                0x004E, 0x0050],   
    ...
    _DeviceType[_DeviceNames[FLOOD]]:        [0x0016], # 0x0001 - removed, Ofer
    _DeviceType[_DeviceNames[TEMPERATURE]]: [0x0016], # 0x0001 - removed, Ofer
    _DeviceType[_DeviceNames[SMOKE_HEAT_TEMP]]: [0x0041],
    _DeviceType[_DeviceNames[SHOCK]]:        [0x0001, 0x0016, 0x001B],
    _DeviceType[_DeviceNames[SHOCK_AUX]]:    [0x01, 0x0016, 0x001F, 0x003E, 0x0040, 0x004F],
    _DeviceType[_DeviceNames[SHOCK_CONTACT]]:[0x01, 0x0016, 0x001F, 0x003E, 0x003F, 0x004F],  
    _DeviceType[_DeviceNames[SHOCK_AUX_CONTACT]]:[0x01, 0x0016, 0x001F, 0x003E, 0x003F, 0x0040, 0x004F],
    _DeviceType[_DeviceNames[SHOCK_AUX_CONTACT_G2]]:[0x01, 0x0016, 0x001F, 0x003E, 0x004F],
    _DeviceType[_DeviceNames[TOWER30]]: [0x0001, 0x0003, 0x0004, 0x0014, 0x0016, 0x0018, 0x001D, 0x0050],   
    _DeviceType[_DeviceNames[TOWER32]]: [0x0001, 0x0003, 0x0004, 0x0011, 0x0014, 0x0015, 0x0016, 0x0018, 0x001D, 0x001E, 0x0050, 0x0051],
    _DeviceType[_DeviceNames[TOWER20]]: [0x0001, 0x0004, 0x000D, 0x0014, 0x0016, 0x0017, 0x0018, 0x0044], # BUG?
    ...
    _DeviceType[_DeviceNames[KP_140]]:  [0x0016, 0x0025, 0x002D, 0x0032], 
    _DeviceType[_DeviceNames[KP_141]]:  [0x0016, 0x0025, 0x002D, 0x0032], # BUG? + 0x0009, 0x002f
    _DeviceType[_DeviceNames[KP_160_STATION]]:[0x0009, 0x0016, 0x0025, 0x002D, 0x002F, 0x0032], # BUG?
    _DeviceType[_DeviceNames[KP_250]]: [], 
    _DeviceType[_DeviceNames[CLIP]]: [0x0001, 0x0002, 0x0004, 0x0014, 0x0016, 0x0018, 0x0050],
    _DeviceType[_DeviceNames[GLASS_BREAK]]: [0x0016], # 0x0001 - removed, Ofer
